...
mkdir -p $dir/wer_clean
$cmd LMWT=$min_lmwt:$max_lmwt $dir/scoring_clean/log/score.LMWT.log \
    cat $dir/scoring_clean/LMWT.tra \| \
    ...
    ark:$dir/scoring_clean/test_filt.txt  ark,p:- ">&" $dir/wer_clean/wer_LMWT || exit 1;
