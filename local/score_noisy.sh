...
mkdir -p $dir/wer_noisy
$cmd LMWT=$min_lmwt:$max_lmwt $dir/scoring_noisy/log/score.LMWT.log \
    cat $dir/scoring_noisy/LMWT.tra \| \
    ...
    ark:$dir/scoring_noisy/test_filt.txt  ark,p:- ">&" $dir/wer_noisy/wer_LMWT || exit 1;
