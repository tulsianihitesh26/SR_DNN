...
utils/silphones.pl data/lang/phones.txt "$silphones" \
...
local/timit_make_questions.pl -i data/lang/phones.txt \
...
utils/add_disambig.pl --include-zero data/lang_test/phones.txt $ndisambig \
...
local/timit_format_lms.sh data
